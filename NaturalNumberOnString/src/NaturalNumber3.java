...
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    public final void multiplyBy10(int k) {
        ...
        /*
         * converting k to a string and concatenating to the end of rep
         */
        if (!(this.rep.length() > 0) && k == 0) {
            this.rep = "";
        } else {
            String end = String.valueOf(k);
            this.rep = this.rep + end;
        }
    }
    ...
    public final int divideBy10() {
        ...
        /*
         * making the last character in the string the remainder and changing
         * rep so it does not have the last character anymore;
         */
        int remainder = 0;
        if (this.rep.length() > 0) {
            String temp = this.rep.substring(this.rep.length() - 1,
                    this.rep.length());
    ...
    public final boolean isZero() {
        ...
        /*
         * checking if the length of rep is more than 0, if not than our natural
         * number is 0
         */
