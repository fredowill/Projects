...
public final class XMLTreeRecursion {
    ...
    private static int tagCount(XMLTree xml, String tag) {
        ...
        if (xml.isTag()) {
            ...
            for (int i = 0; i < xml.numberOfChildren(); i++) {
                tagCount += tagCount(xml.child(i), tag);
            }
        }
        return tagCount;
    ...
    public static void main(String[] args) {
        ...
        /*
         * out.print("Enter the name of a tag: "); String tag = in.nextLine();
         * while (!tag.equals("")) { int count = tagCount(xml, tag);
         * out.println("The tag <" + tag + "> appears " + count + " times.");
         * out.println(); out.print("Enter the name of a tag: "); tag =
         * in.nextLine(); }
         */
        out.println();
