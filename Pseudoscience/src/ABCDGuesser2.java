...
/**
 * * This program gets the user's input of mew, w, x, y, and z all to the power
 * of a number in the charming theory in an attempt to get 0.08% within the
 * value mew.
 *
...
public final class ABCDGuesser2 {
    ...
    private static double approximation(double w, double x, double y, double z,
        ...
        for (u = 0; u < jager.length; u++) {
            for (m = 0; m < jager.length; m++) {
                for (n = 0; n < jager.length; n++) {
                    for (j = 0; j < jager.length; j++) {
